...
export class MyApp {
  ...
  constructor(public platform: Platform, public config: Config, public zone: NgZone) {
    ...
    this.rootPage = helpers.getPageFor("slides");//BasicPage;
  }
        ...
        this.zone.run(() => {
          if (e.data) {
            ...
            setTimeout(() => {
              ...
              helpers.debounce(this.content.setRoot(helpers.getPageFor("inline-labels")),60, false);
